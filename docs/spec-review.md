...
- ~~"Missing normative grammar appendix"~~ — **resolved** by the Cluster-2 grammar appendix decision (`spec_topics/grammar.md` now exists; REQ-IDs would still benefit it but the two findings remain independent)
