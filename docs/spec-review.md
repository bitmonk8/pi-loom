...
_23 findings retained, 1 false positives dropped, 0 persistent failures, 3 resolved (Cluster-A: per-mode tool registration), 5 resolved (P1: typed-query two-phase loop)_
