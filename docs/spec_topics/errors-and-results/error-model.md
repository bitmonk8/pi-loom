...
| Hard-ceiling exhaustion | per the per-ceiling routing class named at [`spec.md` — Hard ceilings](../overview-and-orientation.md#hard-runtime-ceilings) | same | same |
