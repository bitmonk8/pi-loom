...
entries:
  ...
  - { id: F-1404, tier: high, file: docs/plan_topics/V17c-checkpoint-granularity.md, anchor: "`V17c` leaf, **Deps**/**Tests**", title: "`V17c`/`V17c-T` are pickable before the interpreter sites whose per-site checkpoints they assert — and the naive dep-addition fix cycles with `V4f`" }
---
