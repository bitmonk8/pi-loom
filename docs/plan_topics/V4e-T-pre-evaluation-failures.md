...
**Deps.** `V9a`, `V6a`, `V11f`, `V10a`, `V16a`, `V9b`, `V10c` (`V9b` declares the `ReloadFailureInjector` interface (`injectReloadFailure`) the `ERR-7` test injects against; `V10c` contributes the settings-re-merge arm against it)
