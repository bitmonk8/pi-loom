...
**Deps.** `V9a`, `V6a`, `V11f`, `V10a`, `V16a`, `V9b`, `V10c` (the latter two own the **watcher-time reload failure-injection seam** (`ReloadFailureInjector.injectReloadFailure`) the `ERR-7` test injects against)
