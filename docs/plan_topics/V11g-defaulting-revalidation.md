...
**Adds.** The fill-if-absent defaulting: absent wire names take their declared defaults, after which the merged `args` are re-validated through `SchemaValidator.validate()`. The binder system-prompt builder is owned by [`V11d`](./V11d-binder-system-prompt.md); the argument echo by [`V11h`](./V11h-argument-echo.md).
