...
// token resolves to none of the four admitted arms — here a loom/... glob/
// wildcard family, which the loom/... arm's concrete-registry-code resolver
...
export function wildcardFamily(): void {
  try {
    ...
    handle(e);
  } // allow-broad-catch: loom/host/session-shutdown-* — spec/foo.md
}
