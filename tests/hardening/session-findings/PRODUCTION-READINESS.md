...
**Baseline at handoff:** HEAD `178f1542`; `npm test` **1712**, `npm run test:conformance` **26**, `npm run typecheck` + `npm run lint` clean, working tree clean, on `main` (all pushed). Confirm this on start. (Prior handoff was `e1702c87`/1619.)
