...
### CURRENT — Decision 5 remainder answered = Option (a) (do both, then Decision 6)

**Decision 5 remainder — B2 diagnostics/quality gaps.** Maintainer chose **(a)**: do both, drain-state first then query-schema-inference, each its own green+committed phase, then Decision 6.
