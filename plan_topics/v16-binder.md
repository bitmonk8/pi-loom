...
- **Spec.** [Slash-Command Argument Binding](../spec_topics/binder.md) (session-context truncation); [Pi Integration Contract](../spec_topics/pi-integration-contract.md) (`estimateTokens` / `ctx.sessionManager.buildSessionContext` SDK contracts).
