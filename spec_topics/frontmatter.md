...
tool_loop:
  max_rounds: 25               # max model tool-call rounds per query, including the typed-query forced respond turn (default: 25)
params:
  language: string
