...
// runtime MUST mint each `invocationId` and each code-side `theta-direct:`
...
export interface IdSource {
  ...
  /** Canonical lowercase 8-4-4-4-12 hex UUID body for a code-side `theta-direct:` toolCallId. */
